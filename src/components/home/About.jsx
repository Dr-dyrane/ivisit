            ...
            <div className="container space-y-12 px-4 md:px-6">
                ...
                >
                    <div className="space-y-2">
                        ...
                        <p
                            ...
                            data-aos="fade-up"
                        >
                            Our team of highly trained medical professionals is
                            committed to providing rapid response and expert
                            care in times of emergency. We are available 24/7 to
                ...
                >
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="grid gap-1 p-4 rounded-xl bg-muted sm:h-36"
                        >
