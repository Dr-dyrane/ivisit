    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-xs sm:text-sm font-bold text-muted-foreground uppercase tracking-widest">Global Registry Sync</span>
            </div>
          </div>
        </div>
        <div className="text-right">
          ...
          <span className="text-xs sm:text-sm font-black text-blue-500 uppercase tracking-[0.2em] px-2 py-0.5 rounded bg-blue-500/10 border border-blue-500/20">Active Link</span>
        </div>
      </div>
    </div>
  );
