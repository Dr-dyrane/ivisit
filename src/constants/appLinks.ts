...
export const APP_DOWNLOAD_LINKS = {
  ...
  ANDROID: 'https://play.google.com/store/apps/details?id=com.dyrane.ivisit'
};

// Simple utility to detect Android
...
export const getAppDownloadLink = (environment = 'production', forcePlatform?: 'android' | 'ios') => {
  // Auto-detect or force Android Play Store
  if (forcePlatform === 'android' || (environment !== 'preview' && isAndroid())) {
    return APP_DOWNLOAD_LINKS.ANDROID;
  }
